...
const emailTemplate = (Body) => {
  ...
  <div style="font-family: Arial, sans-serif; max-width: 650px; margin: auto; border: 1px solid #e0e0e0; background-color: #ffffff;">
    ...
    <!-- Disclaimer -->
    <div style="background-color: #ffffff; padding: 20px; font-size: 12px; color: #555; font-style: italic; border-top: 1px solid #e0e0e0;">
      <strong>DISCLAIMER:</strong> The information transmitted by this email is intended only for the person or entity to which it is addressed. This email may contain proprietary, business-confidential and/or privileged material. If you are not the intended recipient of this message, be aware that any use, review, retransmission, distribution, reproduction or any action taken in reliance upon this message is strictly prohibited. If you received this in error, please contact the sender and delete the material (email and attachments), electronic or hard copy.
    </div>
